...
EXPERIMENTS = [
    ("measure_item_defaults.py", "Item Defaults", "item"),
    ("measure_get_item_price.py", "Get Item Price", "get_item_details"),
    ("measure_generate_report.py", "Generate Report", "item_wise_sales_register"),
    ("measure_get_buying_amount.py", "Get Buying Amount", "gross_profit"),
    ("measure_reorder_item.py", "Reorder Item", "reorder_item"),
   ("measure_validate_billing.py", "Validate Billing", "accounts_controller"),
]
