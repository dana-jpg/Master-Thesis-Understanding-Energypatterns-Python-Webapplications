...
def get_item_price(args, item_code, ignore_party=False):
    """
    Get name, price_list_rate, uom from Item Price based on conditions
    ...
    if not ignore_party:
        if args.get("customer"):
            ...
            conditions += \
                "and (customer is null or customer = '') and (supplier is null or supplier = '')"
