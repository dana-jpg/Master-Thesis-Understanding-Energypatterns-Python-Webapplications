#!/usr/bin/env python3
"""
Reorder Item - Energy Measurement

Measures energy consumption of get_items_for_reorder function.
"""
...
BENCHMARK_LABEL = "get_items_for_reorder()"
...
RESULTS_FILE = os.environ.get("ENERGY_RESULTS_FILE", "energy_results_reorder_item.json")
...
from erpnext.stock.reorder_item import get_items_for_reorder
...
if __name__ == "__main__":
    ...
    results = ExperimentResults(
        config={
            "experiment_label": BENCHMARK_LABEL,
            "site": SITE,
            "measure_runs": MEASURE_RUNS,
