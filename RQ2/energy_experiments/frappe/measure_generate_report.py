#!/usr/bin/env python3
"""
Gross Profit Report Generation - Energy Measurement

Measures energy consumption of item_wise_sales_register report generation.
Uses fork-based process isolation with setproctitle for accurate per-process measurement.
"""
...
PROCESS_NAME = "erpnext_item_wise_sales_worker"
MEASURE_RUNS = 1000
NUM_TRIALS = 20
NUM_TRIALS = 20
COOLDOWN_SEC = 120
...
RESULTS_FILE = os.environ.get("ENERGY_RESULTS_FILE", "energy_results_generate_report.json")
...
from erpnext.accounts.report.item_wise_sales_register.item_wise_sales_register import (
    execute as run_item_wise_sales_report,
)


# ------------------------------------------
# SINGLE TRIAL (fork-based)
# ------------------------------------------

from typing import Optional

def run_single_trial(trial_idx: int, baseline: Optional[BaselineMeasurement] = None) -> TrialResult:
    """Run one trial using fork-based process isolation."""
    ...
    # Fork for measurement isolation
    r, w = os.pipe()
    pid = os.fork()
...
if __name__ == "__main__":
    ...
    summary = ExperimentSummary(
        ...
        stdev_pkg_power_W=safe_stdev([t.avg_proc_power_W for t in trials]),
    ...
    results = ExperimentResults(
        config={
            "experiment_label": "Item-wise Sales Report",
            "site": SITE,
            "company": COMPANY,
            "filters": FILTERS,
            "measure_runs": MEASURE_RUNS,
